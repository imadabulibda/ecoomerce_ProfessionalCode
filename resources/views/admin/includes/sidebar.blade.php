        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item open">
                <a href="">
                    ...
                    <span class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\Language::where('active',1)->count()}}</span>
                </a>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\MainCategory::where('translation_lang',get_default_lang())->count()}}</span>
                </a>
                <ul class="menu-content">
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    ...
                    <span class="badge badge badge-success badge-pill float-right mr-2">{{App\Models\Vendor::where('active',1)->count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.vendors')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a></li>
                    <li><a class="menu-item" href="{{route('admin.vendors.create')}}" data-i18n="nav.dash.crypto">أضافة متجر جديد </a></li>
                </ul>
            </li>
